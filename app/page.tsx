  ...
  return (
    <main>
      ...
      <header className="nav-shell">
        ...
        <a className="nav-cta" href="#booking">Book consultation <span>&nearr;</span></a>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button primary" href="#booking">Claim 20% off <span>&nearr;</span></a>
            <a className="text-link" href="#science">Explore the science <span>&darr;</span></a>
          </div>
      ...
      <section className="process section" id="process">
        ...
        <div className="process-intro">
          ...
          <p>Every session is mapped around your scalp, your pattern, and your goals&mdash;not a one-size-fits-all protocol.</p>
        </div>
        <div className="process-layout">
          ...
          <div className="steps">
            {treatmentSteps.map((step) => (
              <article key={step.n}>
                <span>{step.n}</span><h3>{step.title}</h3><p>{step.text}</p><i>&nearr;</i>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="candidates section">
        ...
        <div className="candidate-grid">
          <div className="candidate-copy">
            ...
            <p>Exosome therapy is designed for men and women experiencing early-to-moderate changes&mdash;not complete or long-standing baldness.</p>
            <a className="button dark" href="#booking">Check my suitability <span>&nearr;</span></a>
          </div>
      ...
      <section className="reviews section" id="reviews">
        ...
        <div className="review-grid">
          <article className="featured-review"><span>&ldquo;</span><blockquote>My crown looks noticeably denser and the whole experience felt considered from start to finish.</blockquote><footer><b>Abdulrehman M.</b><small>Verified Google review</small></footer></article>
          <article><span>&ldquo;</span><blockquote>My postpartum shedding finally slowed down. The team explained every step and never rushed me.</blockquote><footer><b>Ayesha R.</b><small>Verified Google review</small></footer></article>
          <article><span>&ldquo;</span><blockquote>Non-surgical, clean, and surprisingly comfortable. I feel much more confident about my hairline.</blockquote><footer><b>Xenia M.</b><small>Verified Google review</small></footer></article>
        </div>
      </section>
      ...
      <section className="social-section">
        <div className="social-head">
          ...
          <a href="https://www.instagram.com/rizthetics/" target="_blank" rel="noreferrer">Follow @rizthetics <span>&nearr;</span></a>
        </div>
      ...
      <section className="booking section" id="booking">
        ...
        <form className="booking-form" onSubmit={submitBooking}>
          ...
          <button className="button booking-button" type="submit">Request my consultation <span>&nearr;</span></button>
      ...
      <footer>
        <div className="footer-top"><div className="footer-word">RIZTHETICS</div><a href="#top" aria-label="Back to top">&uarr;</a></div>
        <div className="footer-grid">
          ...
          <div><span>Social</span><a href="https://www.instagram.com/rizthetics/" target="_blank" rel="noreferrer">Instagram &nearr;</a><a href="https://www.google.com/search?q=Rizthetics+Lahore+reviews" target="_blank" rel="noreferrer">Google reviews &nearr;</a></div>
        </div>
        <div className="footer-bottom"><span>&copy; 2026 Rizthetics</span><span>Results vary by individual &middot; Consultation required</span></div>
      </footer>

      <a className="whatsapp-float" href={`https://wa.me/${PHONE}`} target="_blank" rel="noreferrer" aria-label="Chat on WhatsApp"><span>Let&apos;s talk</span><b>&nearr;</b></a>
    </main>
  );
}
